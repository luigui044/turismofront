<template>
    <div class="card flex justify-content-center">
        <Dialog :visible="visible" @update:visible="updateVisible" modal :header="title" :style="{ width: '30vw' }"
            ...
            <template #footer>
                <slot name="footer">
                    <Button type="button" label="Cerrar" severity="secondary" @click="updateVisible(false)"></Button>
